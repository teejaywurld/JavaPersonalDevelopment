...
public class Demo {
    public static void main(String[] args) {
        ...
        addInOrder(placesToVisit, "Plateau");
        addInOrder(placesToVisit, "Maiduguri");
        addInOrder(placesToVisit, "Oshogbo");
        addInOrder(placesToVisit, "Ilorin");
